...
namespace DirectX
{
    ...
    #if defined(USING_GAMEINPUT) || defined(USING_WINDOWS_GAMING_INPUT) || defined(_XBOxONE)
        static constexpr int MAxPLAYER_COUNT = 8;
    #else
        static constexpr int MAxPLAYER_COUNT = 4;
    #endif
    ...
    #elif defined(USING_WINDOWS_GAMING_INPUT) || defined(_XBOxONE)
