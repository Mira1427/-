...
#if (defined(_WIN32) || defined(WINAPI_FAMILY)) && !(defined(_XBOxONE) && defined(_TITLE)) && !defined(_GAMING_XBOX)
#include <dxgi1_2.h>
#endif
...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        public:
        ...
        #if defined(__d3d11_h__) || defined(__d3d11_xh__)
            // Direct3D 11 interop
        ...
        #if defined(__d3d12_h__) || defined(__d3d12_xh__) || defined(__XBOxD3D12_x_)
            // Direct3D 12 interop
            ...
            // Static methods
        #if defined(__dxgi1_2_h__) || defined(__d3d11_xh__) || defined(__d3d12_xh__) || defined(__XBOxD3D12_x_)
