...
namespace DXUT
{
    ...
    // SDKMESH_HEADER
    // SDKMESH_VERTExBUFFER_HEADER header->VertexStreamHeadersOffset
    // SDKMESH_INDExBUFFER_HEADER  header->IndexStreamHeadersOffset
...
#pragma pack(push,8)
    ...
    struct SDKMESH_VERTExBUFFER_HEADER
    {
    ...
    struct SDKMESH_INDExBUFFER_HEADER
    {
        uint64_t NumIndices;
        uint64_t SizeBytes;
        uint32_t IndexType;
...
static_assert(sizeof(DXUT::SDKMESH_VERTExBUFFER_HEADER) == 288, "SDK Mesh structure size incorrect");
static_assert(sizeof(DXUT::SDKMESH_INDExBUFFER_HEADER) == 32, "SDK Mesh structure size incorrect");
