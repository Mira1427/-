...
#elif defined(_XBOxONE) && defined(_TITLE)
#include <xdk.h>
...
#if (defined(WINAPI_FAMILY) && (WINAPI_FAMILY == WINAPI_FAMILY_APP)) || (defined(_XBOxONE) && defined(_TITLE))
#pragma warning(push)
