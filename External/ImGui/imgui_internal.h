...
struct ImGuiTabBar
{
    ...
    ImGuiTabBar();
    int                 GetTabOrder(const ImGuiTabItem* tab) const { return Tabs.indexfrom_pointer(tab); }
};
...
namespace ImGui
{
    ...
    IMGUI_API void          RenderRectFilledRangeH(ImDrawList* draw_list, const ImRect& rect, ImU32 col, float xstart_norm, float xend_norm, float rounding);
