...
void FrameBuffer::clear(ID3D11DeviceContext* context,
...
void FrameBuffer::active(ID3D11DeviceContext* context) {

	viewportCount = D3D11_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE;
	context->RSGetViewports(&viewportCount, cachedViewports);
	context->OMGetRenderTargets(1, cachedRenderTargetView.ReleaseAndGetAddressOf(), cahedDepthStencilView.ReleaseAndGetAddressOf());
...
void FrameBuffer::deactive(ID3D11DeviceContext* context) {

	context->RSSetViewports(viewportCount, cachedViewports);
	context->OMSetRenderTargets(1, cachedRenderTargetView.GetAddressOf(), cahedDepthStencilView.Get());
}
